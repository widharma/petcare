package com.example.py7.petcare.adapters;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String database_name = "db_petcare";
    public static final String tabel_name = "tabel_petcare";
    public static final String row_id = "_id";
    public static final String row_nama = "Nama";
    public static final String row_jenishwn = "hewan";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + tabel_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nama + " TEXT," + row_jenishwn + " TEXT," + row_pinjam + " TEXT," + row_kembali + " TEXT," + row_status + " TEXT)";
        db.execSQL(query);
    }
