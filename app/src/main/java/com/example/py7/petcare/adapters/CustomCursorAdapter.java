...
import com.example.py7.petcare.R;
...
public class CustomCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        holder.ListJenisHewan = (TextView)v.findViewById(R.id.listJenisHewan);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.ListJenisHewan.setText(cursor.getString(cursor.getColumnIndex(DBHelper.row_jenishwn)));
